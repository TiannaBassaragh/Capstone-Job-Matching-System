                ...
                <div className="q-sidebar">
                    <PanelCard>
                        ...
                        <p className="q-info-text">
                            {isRecruiter
                                ? "The system asks when a competency requirement is ambiguous in your job description — for example if a required level or importance couldn't be determined."
                                : "The system asks when a competency score is uncertain — for example if your resume mentions a skill but doesn't show enough depth to rate it."
                            }
                        </p>
